    ...
    <section className="max-w-7xl mx-auto ">
      <div>
        ...
        <p className="mt-2 text-[#666e75] text-[16px] max-w[500px]">
          Create some stunning AI images through DALL-E AI and share them with the Community
        </p>
      </div>
      <form className="mt-16 max-w-3xl" onSubmit={handleSubmit}>
        ...
        <div className="mt-10">
          <p className="mt-2 text-[#666e75] text-14px">
            After you have generated the Image, you can also share it with the Community
          </p>
